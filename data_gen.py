...
def generate_dynamic_wind_tunnel(num_days, num_flights, seed, num_peaks=2):
    records = []
    np.random.seed(seed)
    ...
    for day in range(num_days):
        ...
        for i in range(num_flights):
            ...
            iv = int(20 - 10 * density_factor + np.random.normal(0, 2))
...
if __name__ == "__main__":
    ...
    df_train = generate_dynamic_wind_tunnel(args.days, args.flights, args.seed)
    df_val = generate_dynamic_wind_tunnel(val_days, args.flights, args.seed + 1)
    df_test = generate_dynamic_wind_tunnel(test_days, args.flights, args.seed + 2)
